...
*Chapters using the OWASP meeting Pro account must place the front matter code in their chapter repository to properly mirror the information(date, time, and location/URL) to complete the intended use of the platform. [front matter code] 
